...
const navList = [
  ...
  },
  {
    ...
    activeIcon: <FontAwesomeIcon icon={['fas', 'headset']} />,
    link: agentsRoutes.root,
    text: <FormattedMessage id="core.agents" defaultMessage="agents" />,
  },
  {
  ...
  },
  {
    ...
    link: '/app/settings/businesshours',
